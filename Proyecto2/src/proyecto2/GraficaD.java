...
public class GraficaD {
    ...
    public void graficar(NodoD raiz, String nombre) throws IOException
    {
        String filein;
        String fileout;
    ...
    public void declararNodos(NodoD raiz)
    {
        if(raiz != null)
        {
    ...
    public void enlazarNodos(NodoD raiz, int actual)
    {
        if(raiz != null)
        {
            if(raiz.siguiente != null)
            {   
                indice++;
                pr.println("\"Avión " + (actual+1) + "\":ptr->" + "\"Avión " + (indice+1)+ "\"");
                pr.println("\"Avión " + (indice+1) + "\":ptr->" + "\"Avión " + (actual+1)+ "\"");
                
                enlazarNodos(raiz.siguiente,indice);
                
            } 
        }
                    pr.println("node"+indice+"[label = " +"\"{<val>Llegadas de Aviones}\""+ "] [style=filled];");
    }       
